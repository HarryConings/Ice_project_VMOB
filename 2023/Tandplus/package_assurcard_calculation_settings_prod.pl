...
package assurcard_calculation_settings;
     ...
     sub new {
         ...
         $settings = XMLin("D:\\OGV\\ASSURCARD_2023\\assurcard_settings_xml\\Tandplus_calculation_settings.xml");
     ...
     sub teksten_gkd {
         ...
         $teksten = XMLin("P:\\OGV\\ASSURCARD_2023\\assurcard_settings_xml\\Tandplus_calculation_settings_teksten.xml");
         return ($teksten);
        }
