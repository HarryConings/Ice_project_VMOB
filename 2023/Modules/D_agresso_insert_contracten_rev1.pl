...
package main;
      #bepalen TEST PROD
      our $version = 'v202310'; # EXTRA VELDEN
      our $mode = 'TEST'; #TEST voor test   PROD voor productie
      ...
      our $agresso_instellingen = XMLin("D:\\OGV\\ASSURCARD_2023\\assurcard_settings_xml\\insert_contracten_settings.xml");
      our $file_voor_jo = "D:\\OGV\\ASSURCARD_2023\\CONTRACTEN\\contracten_$vandaag.csv";
      our $file_agresso = '';
      $file_agresso = "\\\\s298file101.zkf200mut.prd\\250-B\\Applicaties\\Agresso\\PRODimport\\Contracten" if  ($mode eq 'PROD');
      $file_agresso = "\\\\s298file101.zkf200mut.prd\\250-B\\Applicaties\\Agresso\\TESTimport\\Contracten" if  ($mode eq 'TEST');
      unlink $file_voor_jo;                 
      $mail_contracten  = $mail_contracten."Programma contracten Milestone 7 naar $mode versie $version\n\n";
...
package mail;
   ...
   sub mail_bericht_contracten {
     ...
     foreach my $geadresseerde (@aan_lijst) {
         ...
         $smtp->datasend("\n");
         $smtp->datasend("$main::mail_contracten\nvriendelijke groeten\nHarry Conings");
         $smtp->dataend;
         $smtp->quit;
