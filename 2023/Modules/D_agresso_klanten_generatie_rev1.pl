...
#REV 1 de xml word gezet op de data import
...
#our $file_agresso_test = "\\\\S200WR2XXL01.mutworld.be\\AgressoFiles235\\VMOB\\Data Import\\Klanten";
...
sub maak_xml_file {
     ...
     my $xml_file = "$agresso_instellingen->{plaats_file}\\klanten_naar_agresso_$nr_zkf\-$vandaag\-B$aantal_blok\_$mode.xml";
...
sub verander_xml_file {
     ...
     my $aantal_blok = shift @_;
     $cdata='';
     $cdata= read_file("$agresso_instellingen->{plaats_file}\\klanten_naar_agresso_$nr_zkf\-$vandaag\-B$aantal_blok\_$mode.xml");
     #$cdata=~ s%^<\?xml%<imp:Xml><![CDATA[<\?xml%;
     #$cdata=~ s%</ABWSupplierCustomer>$%</ABWSupplierCustomer>]]></imp:Xml>%;
     #$cdata=~ s%<ABWSupplierCustom.*<MasterFile>%<ABWSupplierCustomer xsi:schemaLocation=\"http://services\.agresso\.com/schema/ABWSupplierCustomer/2007/12/24 http://services\.agresso\.com/schema/ABWSupplierCustomer/2007/12/24/ABWSupplierCustomer\.xsd" xmlns=\"http://services\.agresso\.com/schema/ABWSupplierCustomer/2007/12/24\" xmlns:agrlib=\"http://services\.agresso\.com/schema/ABWSchemaLib/2007/12/24\" xmlns:xsi=\"http://www\.w3\.org/2001/XMLSchema-instance\" xmlns:ns0="http://www\.openapplications\.org/oagis">\n<MasterFile>%;
     $cdata=~ s%<ABWSupplierCustomer xmlns:agrlib=\"http://services\.agresso\.com/schema/ABWSchemaLib/2007/12/24\">\s+?\n?<MasterFile>%
     ...
     $cdata=~ s/^\n\s+//;                          
     my $file_voor_jo = "$agresso_instellingen->{plaats_file}\\klanten_naar_agresso_$nr_zkf\-$vandaag\-B$aantal_blok\_$mode.xml";
