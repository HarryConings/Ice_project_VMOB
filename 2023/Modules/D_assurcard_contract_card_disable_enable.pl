...
package main;
     ...
     our $contract_cardinstellingen=main->load_assurcard_generation_setting_contact_a('D:\OGV\ASSURCARD_2023\assurcard_settings_xml\assurcard_card_generation_settings.xml');
     our $mode = 'TEST';
