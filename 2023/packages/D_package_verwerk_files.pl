...
package webservice_pdf_to_Agresso;  
     ...
     sub PDF_naar_Agresso {
            ...
            use SOAP::Lite ;
            my $Agresso_server = $agresso_instellingen->{"Agresso_IP_$main::mode"};
            my $proxy = "http://$Agresso_server/service.svc"; # productie
...
package zoek_agresso_nr;
     sub new {
            ...
            #use SOAP::Lite ;
            my $Agresso_server = $agresso_instellingen->{"Agresso_IP_$main::mode"};
            my $proxy = "http://$Agresso_server/service.svc"; # productie/test          
