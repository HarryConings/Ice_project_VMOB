...
package ToolBarMainFrame;
     ...
     sub new {
         ...
         $frame->{mobicoon}=$frame->{frame_toolbar}->AddTool(1106, _T("Mobicoon"), Wx::Bitmap->new("\\\\s298file101.zkf200mut.prd\\250-B\\Applicaties\\Assurcard\\bitmap\\mobicoon.bmp",wxBITMAP_TYPE_ANY), wxNullBitmap, wxITEM_NORMAL, _T("Mobicoon"), "");
