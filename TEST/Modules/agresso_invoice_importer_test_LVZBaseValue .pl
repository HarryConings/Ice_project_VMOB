...
&load_agresso_setting_invoice('P:\OGV\ASSURCARD_PROG\assurcard_settings_xml\agresso_settings.xml');
...
&read_assurcard_invoice('P:\OGV\ASSURCARD_TEST\assurcard_invoices\012.invoice.out.20190501.000800.xml');
