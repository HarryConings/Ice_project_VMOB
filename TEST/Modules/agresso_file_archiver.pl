...
my ($locatie,$locatie_verwerkte_invoices) = &load_agresso_setting_invoice('P:\OGV\ASSURCARD_TEST\assurcard_settings_xml\agresso_settings_V2.xml');
...
sub load_agresso_setting_invoice  {
     ...
     print "ingelezen\n";
     #maak verzekeringen
     return ($agresso_instellingen->{plaats_file},$agresso_instellingen->{plaats_invoices_verwerkt_P});
    }
