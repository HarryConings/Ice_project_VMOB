...
package main;
     ...
     print "P:\\OGV\\ASSURCARD_$mode\\assurcard_settings_xml\\TandPlus_agresso_settings.xml\n";
     main->load_agresso_setting("P:\\OGV\\ASSURCARD_$mode\\assurcard_settings_xml\\TandPlus_agresso_settings.xml"); #nagekeken
...
package Frame;
     ...
     #odfLocalEncoding('iso-8859-15');  #versie 5.2
      sub new {
               ...
               $frame = $frame->SUPER::new(undef, -1,_T("Berekeningsjaren TandPlus Agresso $main::mode -> ip $ip ->  variant = $variant_LG04 "),
