...
sub update_completed_assurcard_verkoopsorder_gemaakt { #
      ...
      #my @test = @main::verzekeringen_niet_in_de_loop ;
      ...
      #$completed_moet_zijn_plus += 1000 if (defined $verzprod2 and $verzprod2 ne '' and  !(uc $verzprod2 ~~ @main::verzekeringen_niet_in_de_loop)  );
      #$completed_moet_zijn_plus += 100 if (defined $verzprod3 and $verzprod3 ne '' and !(uc $verzprod3 ~~ @main::verzekeringen_niet_in_de_loop) );
      #$completed_moet_zijn_plus += 10 if (defined $verzprod4 and $verzprod4 ne '' and !(uc $verzprod4 ~~ @main::verzekeringen_niet_in_de_loop));
      #$completed_moet_zijn_plus += 1 if (defined $verzprod5 and $verzprod5 ne '' and !(uc $verzprod5 ~~ @main::verzekeringen_niet_in_de_loop) );
...
sub update_completed_hospi_verkoopsorder_gemaakt {
      ...
      $completed_code += 10000 if (uc $verzprod1 ~~ @main::verzekeringen_niet_in_de_loop and uc $verzprod2 eq uc $verzprod );
      $completed_code = 1000 if (uc $verzprod2 eq uc $verzprod );
      $completed_code += 1000 if (uc $verzprod2 ~~ @main::verzekeringen_niet_in_de_loop and uc $verzprod2 eq uc $verzprod);
      $completed_code = 100 if (uc $verzprod3 eq uc $verzprod );
      $completed_code += 100 if (uc $verzprod3 ~~ @main::verzekeringen_niet_in_de_loop and uc $verzprod2 eq uc $verzprod);
      $completed_code = 10 if (uc $verzprod4 eq uc $verzprod );
      $completed_code += 10 if (uc $verzprod4 ~~ @main::verzekeringen_niet_in_de_loop and uc $verzprod2 eq uc $verzprod);
      $completed_code = 1 if (uc $verzprod5 eq uc $verzprod );
      $completed_code += 1 if (uc $verzprod5 ~~ @main::verzekeringen_niet_in_de_loop and uc $verzprod2 eq uc $verzprod);
...
sub add_card_lost {
      my ($class,$dbh,$apar_id) =  @_;
      my $client ='VMOB';
      #my $hoeveel = $dbh->selectrow_array("SELECT aantal_kaarten_fx FROM afxvmobalg1 WHERE  client='$client' and Dim_Value= '$apar_id'");
