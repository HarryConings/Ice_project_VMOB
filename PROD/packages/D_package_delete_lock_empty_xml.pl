...
package verwerk_files;
     ...
     sub new {
        ...
        our $mail_text;
         verwerk_files->load_agresso_setting('D:\OGV\ASSURCARD_PROG\assurcard_settings_xml\agresso_settings_V2.xml',"D:\\OGV\\ASSURCARD_$test_prod\\assurcard_settings_xml\\zet_klant_in_agresso_settings_new.xml");
         print '';
