...
package main;
     ...
     our $agresso_instellingen = XMLin('D:\OGV\ASSURCARD_PROG\assurcard_settings_xml\agresso_settings.xml');
     our $PdfToAgresso_instellingen = XMLin('D:\OGV\ASSURCARD_PROG\assurcard_settings_xml\PdfToAgresso_settings.xml');
