...
package main;
     ...
     our $mail = "FACTUREN DIE WE IN HET GKD GEZET HEBBEN\n___________________________________________________\n\n";
     our $mail_niet_gelukt = "\n\nFACTUREN DIE WE NIET IN HET GKD HEBBEN KUNNEN ZETTEN\n___________________________________________________\n\n";
     #$ARGV[0] = 20200120;
     #$ARGV[1] = 20200122;
     if ($ARGV[0]) {
         $vanaf_wanneer = $ARGV[0];
         if ($ARGV[1]) {
             $tot_wanneer = $ARGV[1];
            }else {         
     ...
     our $agresso_instellingen = XMLin('P:\OGV\ASSURCARD_PROG\assurcard_settings_xml\agresso_settings.xml');
     our $PdfToAgresso_instellingen = XMLin('P:\OGV\ASSURCARD_PROG\assurcard_settings_xml\PdfToAgresso_settings.xml');
     ...
     sub wrong_password {
         ...
         $mail =  $mail."--------------------------------------------------------\n\n";
         $mail =  $mail.'P:\OGV\ASSURCARD_PROG\assurcard_settings_xml\PdfToAgresso_settings.xml'."\n\n";
