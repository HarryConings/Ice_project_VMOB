...
package main;
     ...
     main->delfiles("P:\\OGV\\ASSURCARD_PROG\\programmas\\Brieven\\te_herpinten");
     main->load_agresso_setting('P:\OGV\ASSURCARD_PROG\assurcard_settings_xml\zet_klant_in_agresso_settings.xml');
     main->load_brieven_setting('P:\OGV\ASSURCARD_PROG\assurcard_settings_xml\\zet_klant_in_brieven_settings.xml');
     ...
     sub new {
         ...
         if (-e $brief) {
              ...
              my $doc = ooDocument(file =>  "$home_file");     
                ...
                copy ($home_file  => "P:\\OGV\\ASSURCARD_PROG\\programmas\\Brieven\\te_herpinten\\$brief_te_herprinten");      
