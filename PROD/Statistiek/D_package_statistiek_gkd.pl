...
package main;
    ...
    #&teksten_gkd;
    main->load_as400_settings('D:\OGV\ASSURCARD_PROG\assurcard_settings_xml\zet_klant_in_AS400_settings.xml'); #nagezien
    ...
    sub load_statistiek_gkd_instellingen  {
         ...
         print "$file_name ->";
         $statistiek_gkd_instellingen = XMLin('D:\OGV\ASSURCARD_PROG\assurcard_settings_xml\statistiek_gkd_settings.xml');
          print "ingelezen\n";
    ...
    sub teksten_gkd {
         ...
         $teksten = XMLin('D:\OGV\ASSURCARD_PROG\assurcard_settings_xml\zet_klant_in_agresso_settings_Teksten.xml');
