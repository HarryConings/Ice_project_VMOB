...
package main;
     ...
     our $contract_cardinstellingen=main->load_assurcard_generation_setting_contact_a('P:\OGV\ASSURCARD_PROG\assurcard_settings_xml\assurcard_card_generation_settings.xml');
