...
package main;
      ...
      our $agresso_instellingen = XMLin("D:\\OGV\\ASSURCARD_$mode\\assurcard_settings_xml\\insert_contracten_settings.xml");
      our $file_voor_jo = "D:\\OGV\\ASSURCARD_$mode\\CONTRACTEN\\contracten_$vandaag.csv";
      our $file_agresso = '';
